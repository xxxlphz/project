...
cred = credentials.Certificate("ahmed-s-lc-sandbox-firebase-adminsdk-8xqtp-5791efc294.json")
firebase_admin.initialize_app(cred, {'databaseURL':'https://ahmed-s-lc-sandbox-default-rtdb.europe-west1.firebasedatabase.app/'})
